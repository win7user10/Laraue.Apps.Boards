...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.Card", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.CardCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.CardStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.Card", b =>
                {
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.CardCategory", "Category")
                        .WithMany("Cards")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("fk_issues_card_categories_category_id");

                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.CardStatus", "Status")
                        .WithMany()
                    ...
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.TelegramMessage", "TelegramMessage")
                        .WithOne("Card")
                        .HasForeignKey("Laraue.Apps.Boards.DataAccess.Models.Card", "TelegramMessageId")
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.CardStatus", b =>
                {
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.CardCategory", "CardCategory")
                        .WithMany("Statuses")
