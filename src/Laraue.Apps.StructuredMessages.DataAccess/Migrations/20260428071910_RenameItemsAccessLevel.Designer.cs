...
namespace Laraue.Apps.StructuredMessages.DataAccess.Migrations
{
    ...
    [Migration("20260428071910_RenameItemsAccessLevel")]
    partial class RenameItemsAccessLevel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Laraue.Apps.StructuredMessages.DataAccess.Models.EpicOrganizationUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<byte>("ItemAccessLevel")
                        .HasColumnType("smallint")
                        .HasColumnName("item_access_level");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_epic_organization_users");

                    b.HasIndex("EpicId")
                        .HasDatabaseName("ix_epic_organization_users_epic_id");

                    b.HasIndex("OrganizationUserId")
                        .HasDatabaseName("ix_epic_organization_users_organization_user_id");

                    b.ToTable("epic_organization_users", (string)null);
                });
            ...
            modelBuilder.Entity("Laraue.Apps.StructuredMessages.DataAccess.Models.SpaceOrganizationUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_space_organization_users");

                    b.HasIndex("OrganizationUserId")
                        .HasDatabaseName("ix_space_organization_users_organization_user_id");

                    b.HasIndex("SpaceId")
                        .HasDatabaseName("ix_space_organization_users_space_id");

                    b.ToTable("space_organization_users", (string)null);
                });
            ...
            modelBuilder.Entity("Laraue.Apps.StructuredMessages.DataAccess.Models.EpicOrganizationUser", b =>
                {
                    b.HasOne("Laraue.Apps.StructuredMessages.DataAccess.Models.Epic", "Epic")
                        ...
                        .HasConstraintName("fk_epic_organization_users_epics_epic_id");
                    ...
                    b.HasOne("Laraue.Apps.StructuredMessages.DataAccess.Models.OrganizationUser", "OrganizationUser")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_epic_organization_users_organization_users_organization_use");
            ...
            modelBuilder.Entity("Laraue.Apps.StructuredMessages.DataAccess.Models.Issue", b =>
                {
                    b.HasOne("Laraue.Apps.StructuredMessages.DataAccess.Models.Epic", null)
                        .WithMany("Issues")
                        .HasForeignKey("EpicId")
                    ...
                    b.HasOne("Laraue.Apps.StructuredMessages.DataAccess.Models.Organization", "Organization")
                        ...
                        .HasConstraintName("fk_issues_organizations_organization_id");
